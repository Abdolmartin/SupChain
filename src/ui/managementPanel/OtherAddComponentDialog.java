...
public class OtherAddComponentDialog extends AbstractAddOrRemoveDialog {
	...
	public OtherAddComponentDialog(int userID, int productElementID) {
	...
	public void accept(AddRemoveDialogVisitor v) {
		v.visitOtherAddComponentDialog(this);
	}
